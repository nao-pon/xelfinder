...
if (defined('LEGACY_BASE_VERSION')) {
    if (!defined('XOOPSX_COREPACK_VERSION') && defined('_MI_LEGACY_DETAILED_VERSION') && 'CorePack ' === mb_substr(_MI_LEGACY_DETAILED_VERSION, 0, 9)) {
        define('XOOPSX_COREPACK_VERSION', mb_substr(_MI_LEGACY_DETAILED_VERSION, 9));
    }
